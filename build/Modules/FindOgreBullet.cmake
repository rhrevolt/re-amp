...
find_path(OGREBULLET_INCLUDE_DIR Dynamics/OgreBulletDynamicsRigidBody.h
          HINTS ${PC_OGREBULLET_INCLUDEDIR} ${PC_OGREBULLET_INCLUDE_DIRS} ${OGREBULLET_ROOT}/include
	  PATH_SUFFIXES OgreBullet )

find_library(OGREBULLET_LIBRARIES OgreBulletCol OgreBulletDyn
             HINTS ${PC_OGREBULLET_LIBDIR} ${PC_OGREBULLET_LIBRARY_DIRS} ${OGREBULLET_ROOT}/lib )
